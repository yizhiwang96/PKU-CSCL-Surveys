...
## 3D Photo, NeRF
 ...
 Method  | Publication  | Code | Project | Code Idea | Authors
 ---- | ----- | ------  | ------ | ------ | ------ 
 3D Kern  | SIGGRAPH 2019 | [Link](https://github.com/sniklaus/3d-ken-burns) | - | RGBD Inpainting and Point Cloud Rendering | [Simon Niklaus](http://sniklaus.com/welcome)
